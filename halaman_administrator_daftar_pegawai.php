          ...
          <div class="table-responsive">
            <table id="tampilDataTables" class="table table-bordered table-hover table-striped tablesorter" cellspacing="0" width="100%">
              ...
              <tbody>
                <?php
                  $no=1;
                  $tampilDataPegawai = "SELECT * from data_pegawai where jabatan_pegawai!='Administrator'";
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-4">
                                        <label for="sel1">Jabatan : </label>
                                            <select class="form-control" name="jabatan_pegawai" Onchange="getJabatanToMataPelajaran(this.value);" required>
                                              ...
                                              <?php
                                                $tampilDataJabatan = "SELECT * from jabatan where nama_jabatan!='Administrator' and nama_jabatan!='BK' and nama_jabatan!='Kepala Sekolah' ";
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select id="jabatanByMataPelajaran" class="form-control" name="nama_mata_pelajaran_pegawai" required>
