...
if($_SESSION['nip_pegawai']){
    ...
    //inialisasi semester
    $nilai_siswa_transaksi_smt_pengetahuan = "nilai_siswa_transaksi_smt".$semester_angka."_pengetahuan";
    $nilai_siswa_transaksi_smt_keterampilan = "nilai_siswa_transaksi_smt".$semester_angka."_keterampilan";
    // echo $nilai_siswa_transaksi_smt_pengetahuan;
    ...
    $query_pegawai = "SELECT * from data_pegawai where nama_pegawai='$nama_pegawai'";
    ...
    $pengetahuan = "nilai_akhir_nilai_siswa_transaksi_smt".$semester_angka."_pengetahuan";
    $keterampilan = "nilai_akhir_nilai_siswa_transaksi_smt".$semester_angka."_keterampilan";
  ...
  if ($kelas_daftar_kelas == "10" || $kelas_daftar_kelas == "11") {
    ...
    $pdf->SetY(47);
    $pdf->SetX(118);
    $pdf->Cell(70,3.9,'Angka',1,0,'C');//awalnya lebar kolom 17
    // $pdf->Cell(18,3.9,'Predikat',1,0,'C');
    $pdf->SetY(51);
    $pdf->SetX(118);
    $pdf->SetFont('Arial','',7);
    $pdf->Cell(70,3.9,'1 - 100',1,0,'C');//awalnya lebar kolom 17
    ...
    $pdf->Cell(15,3.9,'',1,0,'');
    $pdf->Cell(70,3.9,'',1,0,'C');//ukuran awal 17
    // //$pdf->Cell(18,3.9,'',1,0,'C');
    // $pdf->Cell(70,3.9,$row_pengetahuan["$pengetahuan"],1,0,'C');
    ...
    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='aqh' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);

    // $row_pengetahuans = "$"."row_pengetahuan[".$petik.$pengetahuan.$petik."]";
    // $row_pengetahuans = "$"."row_pengetahuan[".$petik.$pengetahuan.$petik."]";
    // echo $row_pengetahuans;
    // $row_pengetahuans = (string)"$"."row_pengetahuan[".$petik.$pengetahuan;
    // echo $row_pengetahuans;
    ...
    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='aa' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='fqh' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='ski' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='pkn' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='bi' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='barab' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='mtk' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='si' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='bing' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='senbud' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='penjas' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='prakarya' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='bjawa' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='ppmb' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    //1. Ilmu Tafsir
    $query_kkm_mtk = "SELECT * from mata_pelajaran_transaksi where id_mata_pelajaran_mata_pelajaran_transaksi='ilmutaf' && id_kelas_daftar='$id_kelas_daftar'";
    $result_kkm_mtk = mysqli_query($connect, $query_kkm_mtk);
    $row_kkm_mtk = mysqli_fetch_array($result_kkm_mtk);

    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='ilmutaf' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    $pdf->SetX(18);
    $pdf->Cell(5,3.9,'1',1,0,'C');
    $pdf->Cell(80,3.9,'Ilmu Tafsir',1,0,'');
    $pdf->Cell(15,3.9,$row_kkm_mtk['kkm_rendah_mata_pelajaran_transaksi'],1,0,'C');
    $pdf->Cell(70,3.9,$row_pengetahuan["$pengetahuan"],1,0,'C');
    //$pdf->Cell(18,3.9,'',1,0,'C');
    //$pdf->Cell(35,3.9,'asd',1,0,'C');
    ...
    //2. Ilmu Hadits
    $query_kkm_kim = "SELECT * from mata_pelajaran_transaksi where id_mata_pelajaran_mata_pelajaran_transaksi='ilmuhad' && id_kelas_daftar='$id_kelas_daftar'";
    $result_kkm_kim = mysqli_query($connect, $query_kkm_kim);
    $row_kkm_kim = mysqli_fetch_array($result_kkm_kim);

    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='ilmuhad' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    $pdf->SetX(18);
    $pdf->Cell(5,3.9,'2',1,0,'C');
    $pdf->Cell(80,3.9,'Ilmu Hadits',1,0,'');
    ...
    //3. Ilmu Fikih
    $query_kkm_fis = "SELECT * from mata_pelajaran_transaksi where id_mata_pelajaran_mata_pelajaran_transaksi='ilmufik' && id_kelas_daftar='$id_kelas_daftar'";
    $result_kkm_fis = mysqli_query($connect, $query_kkm_fis);
    $row_kkm_fis = mysqli_fetch_array($result_kkm_fis);

    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='ilmufik' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    $pdf->SetX(18);
    $pdf->Cell(5,3.9,'3',1,0,'C');
    $pdf->Cell(80,3.9,'Ilmu Fikih',1,0,'');
    ...
    //3. Ilmu Kalam
    $query_kkm_fis = "SELECT * from mata_pelajaran_transaksi where id_mata_pelajaran_mata_pelajaran_transaksi='ilmukal' && id_kelas_daftar='$id_kelas_daftar'";
    $result_kkm_fis = mysqli_query($connect, $query_kkm_fis);
    $row_kkm_fis = mysqli_fetch_array($result_kkm_fis);

    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='ilmukal' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    $pdf->SetX(18);
    $pdf->Cell(5,3.9,'4',1,0,'C');
    $pdf->Cell(80,3.9,'Ilmu Kalam',1,0,'');
    ...
    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='binglintas' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='ekolintas' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    $pdf->Cell(70,3.9,'Semester '.$semester_angka,1,0,'C');
  ...
  elseif ($kelas_daftar_kelas == "12") {
    ...
    // $query_pengetahuan1 = "SELECT * from nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan where nis_siswa='$nis_siswa'";
    // $result_pengetahuan1 = mysqli_query($connect, $query_pengetahuan1);
    // $row_pengetahuan1 = mysqli_fetch_array($result_pengetahuan1);
    //
    // $query_keterampilan1 = "SELECT * from nama_kelas_$nilai_siswa_transaksi_smt_keterampilan where nis_siswa='$nis_siswa'";
