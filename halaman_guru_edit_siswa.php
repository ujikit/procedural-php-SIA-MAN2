...
<html>
  ...
  <body>
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title">Edit Data Siswa | Wali Kelas</h4>
    </div>
<form class="form-signin" action="backend/guru_edit_siswa.php" method="post" enctype="multipart/form-data">
          ...
          <div class="col-lg-12">
                      ...
                      <div class="col-lg-4">
                          <label for="sel1">Password : </label>
                            <input type="text" class="form-control" name="password_siswa" value="<?php echo $tampil["password_siswa"]; ?>" required>
                          </br>
                      </div>
                      <div class="col-lg-4">
                      ...
                      <div class="col-lg-4">
                          ...
                          <select class="form-control" name="id_kelas_daftar" required>
                            ...
                            ?>
                            <option value="<?php $row["id_kelas_daftar"] ?>"><?php echo $row["id_kelas_daftar"] ?></option>
                            <?php  } ?>
                          </select>
                      </br>
                      </div>
                      ...
                      <div class="col-lg-4">
                          <label for="sel1">Alamat : </label>
                            <input type="text" class="form-control" name="alamat_siswa" value="<?php echo $tampil["alamat_siswa"] ?>" required>
                          </br>
                      </div>
                    ...
                    <div class="col-lg-4">
                      ...
                      <div class="col-lg-4">
                          <label for="sel1">Pada tanggal : </label>
                            <input data-provide="datepicker" type="text" class="form-control" name="diterima_tanggal_siswa" value="<?php echo $tampil['diterima_tanggal_siswa'] ?>">
                          </br>
                      </div>
                      <div class="col-lg-4">
