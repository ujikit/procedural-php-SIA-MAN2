              ...
              <div class="col-lg-12">
                <input type="hidden" class="form-control" name="id_pegawai" value="<?php echo $tampil["id_pegawai"] ?>" readonly>
                  ...
                  <div class="row" style="background:#66ff66">
                      ...
                      <div class="col-lg-4">
                        ...
                        <img name="foto_pegawai0"  src="frontend/img/foto/pegawai/<?php echo $tampil['nip_pegawai']; ?>" style="margin-left:0px;width:130px;border: 15px solid #3e2b14;  padding: 10px;">
                      </div>
                ...
                <div class="col-lg-4">
                    ...
                    <select class="form-control" name="jabatan_pegawai">
                      ...
                      ?>
                      <option value="<?php echo $row["jabatan_pegawai"] ?>"><?php echo $row["jabatan_pegawai"] ?></option>
                      <?php
               ...
               <div class="col-lg-4">
                   ...
                   <select class="form-control" name="nama_mata_pelajaran_pegawai">
                     <?php
                       $tampilMataPelajaranPegawai = "SELECT * from data_pegawai where id_pegawai='$id_pegawai'";
                       $tampil = mysqli_query($connect, $tampilMataPelajaranPegawai);
                       $row=mysqli_fetch_array($tampil);
                     ?>
                     <option value="<?php echo $row["nama_mata_pelajaran_pegawai"] ?>"><?php echo $row["nama_mata_pelajaran_pegawai"] ?></option>
                     <?php
                       $tampilDataMataPelajaran = "SELECT DISTINCT nama_mata_pelajaran from mata_pelajaran";
