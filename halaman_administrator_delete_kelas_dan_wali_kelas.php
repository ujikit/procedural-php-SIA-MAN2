    ...
    <div class="modal-body">
      <div class="row">
        <div class="col-lg-12">
          ...
          <?php
          $deleteAtasNama = "SELECT * from kelas_transaksi inner join kelas_daftar on kelas_transaksi.kd_kelas_daftar_kelas_transaksi = kelas_daftar.kd_kelas_daftar where kd_kelas_daftar_kelas_transaksi='$kd_kelas_daftar_kelas_transaksi'";
          $query = mysqli_query($connect, $deleteAtasNama);
          while($result=mysqli_fetch_array($query)){
          ?>
          <p>Apakah Anda Ingin Menghapus Data Kelas dengan Nama : &nbsp<b style="font-size:17px;"><?php echo $result["nama_kelas_daftar"]  ?></b> ? </p>
          <?php
          }
          ?>
        </div>
