          ...
          <div class="row" style="background:#66ff66">
            <input type="hidden" name="nis_siswa" value="<?php echo $tampil["nis_siswa"] ?>">
              ...
              <div class="col-lg-4">
                ...
                <img  src="frontend/img/foto/siswa/<?php echo $tampil['nis_siswa']; ?>" style="margin-left:0px;width:130px;border: 15px solid #3e2b14;  padding: 10px;">
              </div>
              <div class="col-lg-4">
            ...
            <div class="row">
              <div class="col-lg-4">
                ...
                <input style="background:#e6e6e6" type="text" class="form-control" name="name" value="<?php echo $tampil["kd_kelas_daftar_siswa"] ?>" readonly>
                <!-- <select class="form-control" name="kd_kelas_daftar_siswa" required>
                  <option value="<?php echo $tampil["kd_kelas_daftar_siswa"] ?>"><?php echo $tampil["kd_kelas_daftar_siswa"] ?> </option>
                  <?php
                    $tampilDataKelas = "SELECT * from kelas_daftar";
                    $tampil = mysqli_query($connect, $tampilDataKelas);
                    while($row=mysqli_fetch_array($tampil)){
                  ?>
                  <option value="<?php echo $row["kd_kelas_daftar_siswa"] ?>"><?php echo $row["kd_kelas_daftar_siswa"] ?></option>
                  <?php  } ?>
                </select> -->
                </br>
              </div>
            ...
            <div class="row">
              <div class="col-lg-4">
                ...
                <input type="text" class="form-control" name="kd_kelas_daftar_siswa"  value="<?php echo $tampil["kd_kelas_daftar_siswa"] ?>" readonly>
                </br>
              </div>
              <!-- <div class="col-lg-4">
