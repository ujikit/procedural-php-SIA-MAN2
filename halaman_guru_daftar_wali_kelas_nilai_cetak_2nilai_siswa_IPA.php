...
if($_SESSION['nip_pegawai']){
  ...
  if ($kelas_daftar_kelas == "10" || $kelas_daftar_kelas == "11") {
    ...
    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='kim' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='fis' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='bio' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
