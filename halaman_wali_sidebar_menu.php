  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class=""><a href="halaman_wali.php"><i class="glyphicon glyphicon-home"></i> <span>Home</span></a></li>
        <li class=""><a href="halaman_wali_cek_nilai.php"><i class="glyphicon glyphicon-th-list"></i> <span>Cek Hasil Belajar</span></a></li>
