...
if($_SESSION['nip_pegawai']){
  ...
  if ($kelas_daftar_kelas == "10" || $kelas_daftar_kelas == "11") {
    ...
    //1. Matematika
    $query_kkm_mtk = "SELECT * from mata_pelajaran_transaksi where id_mata_pelajaran_mata_pelajaran_transaksi='sos' && id_kelas_daftar='$id_kelas_daftar'";
    $result_kkm_mtk = mysqli_query($connect, $query_kkm_mtk);
    $row_kkm_mtk = mysqli_fetch_array($result_kkm_mtk);

    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='sos' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    //2. Kimia
    $query_kkm_kim = "SELECT * from mata_pelajaran_transaksi where id_mata_pelajaran_mata_pelajaran_transaksi='sjr' && id_kelas_daftar='$id_kelas_daftar'";
    $result_kkm_kim = mysqli_query($connect, $query_kkm_kim);
    $row_kkm_kim = mysqli_fetch_array($result_kkm_kim);

    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='sjr' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    //3. Fisika
    $query_kkm_fis = "SELECT * from mata_pelajaran_transaksi where id_mata_pelajaran_mata_pelajaran_transaksi='geo' && id_kelas_daftar='$id_kelas_daftar'";
    $result_kkm_fis = mysqli_query($connect, $query_kkm_fis);
    $row_kkm_fis = mysqli_fetch_array($result_kkm_fis);

    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='geo' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
    ...
    //4. Biologi
    $query_kkm_bio = "SELECT * from mata_pelajaran_transaksi where id_mata_pelajaran_mata_pelajaran_transaksi='eko' && id_kelas_daftar='$id_kelas_daftar'";
    $result_kkm_bio = mysqli_query($connect, $query_kkm_bio);
    $row_kkm_bio = mysqli_fetch_array($result_kkm_bio);

    $query_pengetahuan = "SELECT * from $nilai_siswa_transaksi_smt_pengetahuan where nis_siswa_$nilai_siswa_transaksi_smt_pengetahuan='$nis_siswa' and id_mata_pelajaran_$nilai_siswa_transaksi_smt_pengetahuan='eko' and nama_kelas_$nilai_siswa_transaksi_smt_pengetahuan='$id_kelas_daftar' and nip_pegawai_$nilai_siswa_transaksi_smt_pengetahuan='$nip_pegawai'";
    $result_pengetahuan = mysqli_query($connect, $query_pengetahuan);
    $row_pengetahuan = mysqli_fetch_array($result_pengetahuan);
