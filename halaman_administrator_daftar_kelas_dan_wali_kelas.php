                ...
                <tbody id="tampilDataDaftarKelasdanWaliKelas">
                  ...
                  <tr>
                    ...
                    <td style="border-radius:0px;margin:0 auto;text-align:center;position:relative;float:center">
                          ...
                          <a type="button" class="btn btn-danger" href="javascript:deleteKelas('<?php echo $row['id_kelas_transaksi'] ?>','<?php echo $row['id_kelas_daftar'] ?>')" ><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                    </td>
                  </tr>
                  <?php  } ?>
                </tbody>
                        ...
                        <div class="col-lg-12">
                          <div class="row">
                            ...
                            <label for="sel1">Nama Kelas </label>
                                <select class="form-control" name="nama_kelas_transaksi" required>
                                ...
                                <label for="sel1">Wali Kelas </label>
                                    <select class="form-control" name="wali_kelas_transaksi" required>
                                      <option value="">Pilih Wali Kelas : </option>
                                      <?php
                                        $no=1;
                                        $tampilDataJabatan = "SELECT * from data_pegawai where nama_pegawai!='admin'";
                                        $tampil = mysqli_query($connect, $tampilDataJabatan);
                                        while($row=mysqli_fetch_array($tampil)){
                                      ?>
