...
<html lang="en">
  <head>
    ...
    <title>Portal Login Siswa</title>
...
<?php include_once "index_sidebar.php" ?>
      ...
      <div class="col-lg-8">
         ...
         <div class="blog-masthead" style="background:#009933;height:45px;margin-top:20px;">
                    <a href="#" class="list-group-item active active" style="z-index:1;border:0px;margin:0 auto;text-align:center;position:relative;font-size:18px;background:#009933;float:center"><b>Portal Login Siswa</b></a>
                  </div>
                  ...
                  <div class="row" style="background:#d6f5d6;">
                    ...
                    <div class="card card-container" style="margin-top:0px;">
                        <!-- <img class="profile-img-card" src="//lh3.googleusercontent.com/-6V8xOA6M7BA/AAAAAAAAAAI/AAAAAAAAAAA/rzlHcD0KYwo/photo.jpg?sz=120" alt="" /> -->
                          <img id="profile-img" class="profile-img-card" src="frontend/img/siswa.png" style="margin-top: -20px; margin-bottom: -20px" />
                              <p id="profile-name" class="profile-name-card"></p>
                                <form class="form-signin" action="backend/cek_login_siswa.php" method="post">
                                  ...
                                  <input type="hidden" name="jam_terpakai_verifikasi_password_baru" value="<?php echo date("H:i:s") ?>">
                                    <div class="form-group">
                                     ...
                                     <label for="sel1">Masukan NIS Siswa : </label>
                                      <input type="text" id="inputEmail" class="form-control" placeholder="Masukan NIS" name="nis_siswa" required>
                                      <label for="sel1">Masukan Password : </label>
                                      <input type="password" id="inputPassword" class="form-control" placeholder="Masukan Password" name="password_siswa" required>
                                      <button class="btn btn-lg btn-primary btn-block btn-signin" type="submit">Sign in</button>
                                </form><!-- /form -->
                                <a style="font-size:13.5px;" data-toggle="modal" type="button" class="btn btn-danger" data-target="#lupaPasswordSiswa"><i class="fa fa-plus"></i>Lupa Password?</a>
                    </div><!-- /card-container -->
                  </div>
                </div>
      ...
      <div id="lupaPasswordSiswa" class="modal fade">
              ...
              <div class="modal-content">
                ...
                <form class="form-signin" action="backend/lupa_password.php" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="row">
                              <div class="col-lg-12">
                                <input type="hidden" name="lupa_password" value="<?php echo "LupaPasswordSiswa" ?>">
                                ...
                                <label for="sel1">Password Baru Siswa : </label>
                                <input type="text" class="form-control" name="password_baru_verifikasi_password_baru" required oninvalid="this.setCustomValidity('Masukan Password Baru')" oninput="setCustomValidity('')">
                              </div>
                            </div>
