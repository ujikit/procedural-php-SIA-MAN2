...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="content-wrapper" style="background:white;">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="border-radius:0px;margin:0 auto;text-align:center;position:relative;float:center">
                        ...
                        <a type="button" class="btn btn-danger" href="javascript:deletePengampuMataPelajaran('<?php echo $row['id_mata_pelajaran_transaksi'] ?>')" ><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                  </td>
                </tr>
                <?php  } ?>
              </tbody>
    ...
    <div id="detailDataPengampuMataPelajaran" class="modal fade">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
              <div id="tampil"></div>
              <?php
    ...
    <div id="editDataPengampuMataPelajaran" class="modal fade">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
              <div id="edit"></div>
              <?php
    ...
    <div id="deleteDataPengampuMataPelajaran" class="modal fade">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
              <div id="delete"></div>
              <?php
