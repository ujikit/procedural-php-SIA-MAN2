            ...
            <table id="tampilDataTables" class="table table-bordered table-hover table-striped tablesorter" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="border-radius:0px;margin:0 auto;text-align:center;position:relative;float:center"><?php echo $row["id_kelas_daftar"] ?></td>
                  <td style="border-radius:0px;margin:0 auto;text-align:center;position:relative;float:center"><img  src="frontend/img/foto/siswa/<?php echo $row['nisn_siswa']; ?>" class="img-circle" style="width:50px;"></td>
                                        ...
                                        <label for="sel1">Kelas : </label>
                                            <select class="form-control" name="id_kelas_daftar" required>
                                              ...
                                              <?php
                                                ...
                                                while($row=mysqli_fetch_array($tampil)){
                                              ?>
                                              <option value="<?php echo $row["id_kelas_daftar"] ?>"><?php echo $row["nama_kelas_daftar"] ?></option>
                                              <?php  } ?>
                                            </select>
                                    </br>
                                    </div>
