...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="content-wrapper" style="background:white;">
    <section class="content-header">
      <h1> Dashboard  <small>Panel Wali Kelas</small></h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Panel Wali Kelas</li>
      </ol>
    </section>
              ...
              <table id="tampilDataTables" class="table table-bordered table-hover table-striped tablesorter" cellspacing="0" width="100%">
                ...
                <tbody>
                  <?php
                    ...
                    $tampilDataPegawai = "SELECT * from kelas_transaksi where wali_kelas_transaksi='$nama_pegawai' order by nama_kelas_transaksi asc";
                  ...
                  <tr>
                    ...
                    <td style="border-radius:0px;margin:0 auto;text-align:center;position:relative;float:center">
                        <a type="button" class="btn btn-success" href="javascript:detailSemuaNilaiSiswaWaliKelas('<?php echo $row['id_kelas_daftar'] ?>')" ><span class="glyphicon glyphicon-book" aria-hidden="true"></span> Raport Siswa</a>
                    </td>
                  </tr>
                  <?php  } ?>
                </tbody>
